<template>
  <div
    :class="[
    type === 'textarea' ? 'dm-textarea' : 'dm-input',
    inputSize ? 'dm-input--' + inputSize : '',
    {
      'is-disabled': inputDisabled,
      'is-exceed': inputExceed,
      'dm-input-group': $slots.prepend || $slots.append,
      'dm-input-group--append': $slots.append,
      'dm-input-group--prepend': $slots.prepend,
      'dm-input--prefix': $slots.prefix || prefixIcon,
      'dm-input--suffix': $slots.suffix || suffixIcon || clearable || showPassword
    }
    ]"
  ...
  >
    <template v-if="type !== 'textarea'">
      ...
      <!-- 前置内容 -->
      <span
        class="dm-input__prefix"
        v-if="$slots.prefix || prefixIcon"
      >
        <slot name="prefix"></slot>
        <i
          class="dm-input__icon"
          v-if="prefixIcon"
          :class="prefixIcon"
        >
        </i>
      ...
      >
        <span class="dm-input__suffix-inner">
          ...
          <i
            v-if="showClear"
            class="dm-input__icon dm-icon-circle-close dm-input__clear"
            @mousedown.prevent
            @click="clear"
          ></i>
          <i
          ...
          <span
            ...
            class="dm-input__count"
          >
            <span class="dm-input__count-inner">
  ...
  methods: {
    ...
    calcIconOffset(place) {
      let elList = [].slice.call(
        this.$el.querySelectorAll(`.dm-input__${place}`) || []
      );
      ...
      if (this.$slots[pendant]) {
        el.style.transform = `translateX(${place === 'suffix' ? '-' : ''}${
          this.$el.querySelector(`.dm-input-group__${pendant}`).offsetWidth
        }px)`;
      } else {
