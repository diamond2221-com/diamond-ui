<template>
  <transition
    ...
    <div
      v-show="visible"
      class="dm-time-range-picker dm-picker-panel dm-popper"
      :class="popperClass">
      <div class="dm-time-range-picker__content">
        <div class="dm-time-range-picker__cell">
          <div class="dm-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="dm-time-range-picker__body dm-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="dm-time-range-picker__cell">
          <div class="dm-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="dm-time-range-picker__body dm-time-panel__content">
            <time-spinner
      ...
      <div class="dm-time-panel__footer">
        <button
          type="button"
          class="dm-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="dm-time-panel__btn confirm"
          @click="handleConfirm()"
