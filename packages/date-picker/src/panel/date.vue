<template>
  <transition name="dm-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="dm-picker-panel dm-date-picker dm-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="dm-picker-panel__body-wrapper">
        <slot name="sidebar" class="dm-picker-panel__sidebar"></slot>
        <div class="dm-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="dm-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{ shortcut.text }}</button>
        </div>
        <div class="dm-picker-panel__body">
          <div class="dm-date-picker__time-header" v-if="showTime">
            <span class="dm-date-picker__editor-wrap">
              <dm-input
            ...
            <span class="dm-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <dm-input
                ref="input"
          ...
          <div
            class="dm-date-picker__header"
            :class="{ 'dm-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="dm-picker-panel__icon-btn dm-date-picker__prev-btn dm-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="dm-picker-panel__icon-btn dm-date-picker__prev-btn dm-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="dm-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="dm-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="t(`el.datepicker.nextYear`)"
              class="dm-picker-panel__icon-btn dm-date-picker__next-btn dm-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="dm-picker-panel__icon-btn dm-date-picker__next-btn dm-icon-arrow-right">
            </button>
          </div>

          <div class="dm-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, DmInput, DmButton
    },
