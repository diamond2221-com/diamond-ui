<template>
  <transition name="dm-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="dm-picker-panel dm-date-range-picker dm-popper"
      :class="[{
      ...
      <div class="dm-picker-panel__body-wrapper">
        ...
        <div class="dm-picker-panel__body">
          <div class="dm-date-range-picker__time-header" v-if="showTime">
            <span class="dm-date-range-picker__editors-wrap">
            ...
            <span class="dm-icon-arrow-right"></span>
            <span class="dm-date-range-picker__editors-wrap is-right">
              <span class="dm-date-range-picker__time-picker-wrap">
                <dm-input
                  size="small"
                  class="dm-date-range-picker__editor"
          ...
          <div class="dm-picker-panel__content dm-date-range-picker__content is-left">
            <div class="dm-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="dm-picker-panel__icon-btn dm-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="dm-picker-panel__icon-btn dm-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="dm-picker-panel__icon-btn dm-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="dm-picker-panel__icon-btn dm-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="dm-picker-panel__content dm-date-range-picker__content is-right">
            <div class="dm-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="dm-picker-panel__footer" v-if="showTime">
        <dm-button
          size="mini"
          type="text"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: { TimePicker, DateTable, DmInput, DmButton }
  };
</script>
