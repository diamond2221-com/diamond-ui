<template>
  <div class="dm-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <dm-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="dm-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="dm-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="dm-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="dm-time-spinner__arrow dm-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="dm-time-spinner__arrow dm-icon-arrow-down"></i>
        <ul class="dm-time-spinner__list" ref="hours">
          <li
            class="dm-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="dm-time-spinner__arrow dm-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="dm-time-spinner__arrow dm-icon-arrow-down"></i>
        <ul class="dm-time-spinner__list" ref="minutes">
          <li
            class="dm-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="dm-time-spinner__arrow dm-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="dm-time-spinner__arrow dm-icon-arrow-down"></i>
        <ul class="dm-time-spinner__list" ref="seconds">
          <li
