<template>
  <dm-input
    class="dm-date-editor"
    :class="'dm-date-editor--' + type"
  ...
  <div
    class="dm-date-editor dm-range-editor dm-input__inner"
    :class="[
      'dm-date-editor--' + type,
      pickerSize ? `dm-range-editor--${ pickerSize }` : '',
    ...
    v-clickoutside="handleClose"
    v-else>
    <i :class="['dm-input__icon', 'dm-range__icon', triggerClass]"></i>
    <input
      autocomplete="off"
    ...
    <slot name="range-separator">
      <span class="dm-range-separator">{{ rangeSeparator }}</span>
    </slot>
    <input
      autocomplete="off"
    ...
    <i
      ...
      v-if="haveTrigger"
      :class="[showClose ? '' + clearIcon : '']"
      class="dm-input__icon dm-range__close-icon">
    </i>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    triggerClass() {
      return this.prefixIcon || (this.type.indexOf('time') !== -1 ? 'dm-icon-time' : 'dm-icon-date');
    },
