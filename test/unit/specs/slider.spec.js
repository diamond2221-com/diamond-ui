...
describe('Slider', () => {
  ...
  it('should not exceed min and max', done => {
    vm = createVue({
      template: `
        <div>
          <dm-slider v-model="value" :min="50">
          </dm-slider>
        </div>
      `,
  ...
  it('hide tooltip', () => {
    vm = createVue({
      template: `
        <div>
          <dm-slider v-model="value" :show-tooltip="false">
          </dm-slider>
        </div>
      `,
  ...
  it('format tooltip', async() => {
    vm = createVue({
      template: `
        <div>
          <dm-slider ref="slider" v-model="value" :format-tooltip="formatTooltip">
          </dm-slider>
        </div>
      `,
  ...
  it('drag', done => {
    vm = createVue({
      template: `
        <div>
          <dm-slider v-model="value" :vertical="vertical"></dm-slider>
        </div>
      `,
  ...
  it('accessibility', done => {
    vm = createVue({
      template: `
        <div>
          <dm-slider v-model="value"></dm-slider>
        </div>
      `,
    ...
    vm = createVue({
      template: `
        <div style="width: 200px;">
          <dm-slider v-model="value" :min="0" :max="1" :step="0.1"></dm-slider>
        </div>
      `,
  ...
  it('change event', done => {
    vm = createVue({
      template: `
        <div>
          <dm-slider v-model="value" @change="onChange">
          </dm-slider>
        </div>
      `,
  ...
  it('disabled', done => {
    vm = createVue({
      template: `
        <div>
          <dm-slider v-model="value" disabled></dm-slider>
        </div>
      `,
  ...
  it('show input', done => {
    vm = createVue({
      template: `
        <div>
          <dm-slider v-model="value" show-input></dm-slider>
        </div>
      `,
    ...
    setTimeout(() => {
      triggerEvent(vm.$el.querySelector('.dm-input-number'), 'keyup');
      const inputNumber = vm.$el.querySelector('.dm-input-number').__vue__;
  ...
  it('show stops', () => {
    ...
    const stops = vm.$el.querySelectorAll('.dm-slider__stop');
  ...
  it('vertical mode', done => {
    vm = createVue({
      template: `
        <div>
          <dm-slider vertical v-model="value" height="200px"></dm-slider>
        </div>
      `,
  ...
  describe('range', () => {
    it('basic ranged slider', () => {
      vm = createVue({
        template: `
        <div>
          <dm-slider v-model="value" range></dm-slider>
        </div>
      `,
    ...
    it('should not exceed min and max', done => {
      vm = createVue({
        template: `
        <div>
          <dm-slider v-model="value" range :min="50">
          </dm-slider>
        </div>
      `,
    ...
    it('click', done => {
      vm = createVue({
        template: `
        <div style="width: 200px;">
          <dm-slider range v-model="value"></dm-slider>
        </div>
      `,
    ...
    it('responsive to dynamic min and max', done => {
      vm = createVue({
        template: `
        <div>
          <dm-slider v-model="value" range :min="min" :max="max">
          </dm-slider>
        </div>
      `,
    ...
    it('marks', async() => {
      ...
      waitImmediate();
      const stops = vm.$el.querySelectorAll('.dm-slider__marks-stop.dm-slider__stop');
      const marks = vm.$el.querySelectorAll('.dm-slider__marks .dm-slider__marks-text');
