...
describe('Radio', () => {
  ...
  it('create', done => {
    vm = createVue({
      template: `
        <dm-radio v-model="radio" label="a">
        </dm-radio>
      `,
      data() {
        return {
    ...
    let radioElm = vm.$el;
    expect(radioElm.classList.contains('dm-radio')).to.be.true;
    radioElm.click();
    setTimeout(_ => {
  ...
  describe('Radio group', () => {
    it('create', done => {
      vm = createVue({
        template: `
          <dm-radio-group v-model="radio">
            <dm-radio :label="3" ref="radio1">备选项</dm-radio>
            <dm-radio :label="6" ref="radio2">备选项</dm-radio>
            <dm-radio :label="9">备选项</dm-radio>
          </dm-radio-group>
        `,
        data() {
          return {
    ...
    it('disabled', done => {
      vm = createVue({
        template: `
          <dm-radio-group v-model="radio" disabled>
            <dm-radio :label="3" ref="radio1">备选项</dm-radio>
            <dm-radio :label="6" ref="radio2">备选项</dm-radio>
            <dm-radio :label="9">备选项</dm-radio>
          </dm-radio-group>
    ...
    it('change event', done => {
      vm = createVue({
        template: `
          <dm-radio-group v-model="radio" @change="onChange">
            <dm-radio :label="3">备选项</dm-radio>
            <dm-radio :label="6" ref="radio2">备选项</dm-radio>
            <dm-radio :label="9">备选项</dm-radio>
          </dm-radio-group>
        `,
    ...
    it('disabled when children is radio button', done => {
      vm = createVue({
        template: `
          <dm-radio-group v-model="radio" disabled>
            <dm-radio-button :label="3" ref="radio1">备选项</dm-radio-button>
            <dm-radio-button :label="6" ref="radio2">备选项</dm-radio-button>
            <dm-radio-button :label="9">备选项</dm-radio-button>
          </dm-radio-group>
        `,
        data() {
          return {
    ...
    it('keyboard event', done => {
      vm = createVue({
        template: `
          <dm-radio-group v-model="radio">
            <dm-radio-button ref="radio1" :label="3">备选项</dm-radio-button>
            <dm-radio-button ref="radio2" :label="6">备选项</dm-radio-button>
            <dm-radio-button ref="radio3" :label="9">备选项</dm-radio-button>
          </dm-radio-group>
        `,
        data() {
          return {
    ...
    describe('Radio Button', () => {
      ...
      it('custom color', done => {
        vm = createVue({
          template: `
            <dm-radio-group v-model="radio" fill="#000" text-color="#ff0">
              <dm-radio-button :label="3" ref="radio1">备选项</dm-radio-button>
              <dm-radio-button :label="6" ref="radio2">备选项</dm-radio-button>
              <dm-radio-button :label="9">备选项</dm-radio-button>
            </dm-radio-group>
      ...
      it('change event', done => {
        vm = createVue({
          template: `
            <dm-radio-group v-model="radio" @change="onChange">
              <dm-radio-button :label="3">备选项</dm-radio-button>
              <dm-radio-button :label="6" ref="radio2">备选项</dm-radio-button>
              <dm-radio-button :label="9">备选项</dm-radio-button>
            </dm-radio-group>
          `,
      ...
      it('size', done => {
        vm = createVue({
          template: `
            <dm-radio-group v-model="radio" size="large">
              <dm-radio-button :label="3" ref="radio1">备选项</dm-radio-button>
              <dm-radio-button :label="6" ref="radio2">备选项</dm-radio-button>
              <dm-radio-button :label="9">备选项</dm-radio-button>
            </dm-radio-group>
        ...
        setTimeout(_ => {
          expect(vm.$el.querySelectorAll('.dm-radio-button--large').length).to.be.equal(3);
          done();
        }, 10);
      });
    });
