...
describe('InputNumber', () => {
  ...
  it('decrease', done => {
    vm = createVue({
      template: `
        <dm-input-number v-model="value" ref="input">
        </dm-input-number>
      `,
      data() {
        return {
    ...
    let input = vm.$el.querySelector('input');
    let btnDecrease = vm.$el.querySelector('.dm-input-number__decrease');
  ...
  it('increase', done => {
    ...
    let input = vm.$el.querySelector('input');
    let btnIncrease = vm.$el.querySelector('.dm-input-number__increase');
  ...
  it('disabled', done => {
    vm = createVue({
      template: `
        <dm-input-number v-model="value" disabled>
        </dm-input-number>
      `,
      data() {
        return {
  ...
  it('step', done => {
    vm = createVue({
      template: `
        <dm-input-number v-model="value" :step="3.2">
        </dm-input-number>
      `,
      data() {
        return {
  ...
  it('step strictly', async() => {
    vm = createVue({
      template: `
        <dm-input-number v-model="value" :step="1.2" step-strictly>
        </dm-input-number>
      `,
      data() {
        return {
  ...
  it('min', done => {
    vm = createVue({
      template: `
        <dm-input-number v-model="value" :min="6">
        </dm-input-number>
      `,
      data() {
        return {
  ...
  it('max', done => {
    vm = createVue({
      template: `
        <dm-input-number v-model="value" :max="8">
        </dm-input-number>
      `,
      data() {
        return {
  ...
  describe('precision', () => {
    it('precision is 2', () => {
      vm = createVue({
        template: `
          <dm-input-number v-model="value" :max="8" :precision="2">
          </dm-input-number>
        `,
        data() {
          return {
    ...
    it('precision greater than the precision of step', done => {
      vm = createVue({
        template: `
          <dm-input-number v-model="value" :max="8" :precision="0" :step="0.1">
          </dm-input-number>
        `,
        data() {
          return {
      ...
      const btnIncrease = vm.$el.querySelector('.dm-input-number__increase');
  ...
  it('controls', () => {
    vm = createVue({
      template: `
        <dm-input-number :controls="false" v-model="value" :max="8">
        </dm-input-number>
      `,
      data() {
        return {
    ...
    expect(vm.$el.querySelector('.dm-input-number__decrease')).to.not.exist;
    expect(vm.$el.querySelector('.dm-input-number__increase')).to.not.exist;
  });
  it('invalid value reset', done => {
    vm = createVue({
      template: `
        <dm-input-number v-model="value" :min="5" :max="10" ref="inputNumber">
        </dm-input-number>
      `,
      data() {
        return {
  ...
  describe('event:change', () => {
    ...
    beforeEach(() => {
      vm = createVue({
        template: `
          <dm-input-number v-model="value" ref="compo" :min='2' :max='3' :step='1'>
          </dm-input-number>
        `,
        data() {
          return {
  ...
  it('focus', done => {
    vm = createVue({
      template: `
        <dm-input-number ref="input"></dm-input-number>
      `
    }, true);
