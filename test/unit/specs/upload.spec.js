  ...
  describe('ajax upload', () => {
    ...
    beforeEach(() => {
      uploader = createVue({
        render(h) {
          return (
            <dm-upload {...props} ref="upload">
              <dm-button size="small" type="primary">点击上传</dm-button>
            </dm-upload>
          );
        }
      }, true).$refs.upload;
    ...
    it('preview file', done => {
      ...
      handlers.onSuccess = (res, file, fileList) => {
        uploader.$nextTick(_ => {
          uploader.$el.querySelector('.dm-upload-list .is-success a').click();
        });
      };
    ...
    it('file remove', done => {
      ...
      handlers.onSuccess = (res, file, fileList) => {
        uploader.$el.querySelector('.dm-upload-list .dm-icon-close').click();
        uploader.$nextTick(_ => {
